			...
			<table class="form-table widgetopts-settings-section">
				<tr>
					...
					<td>
						...
						<label for="widgetopts-visibility-inherit"><?php _e( 'Enable Inherit Page Parent Visibility', 'widget-options' );?></label>
						<p class="description">
							<?php _e( 'Check this option if you want your child pages to inherit pages widget visibility option from there parent.', 'widget-options' );?>
						</p>
					</td>
				</tr>
			</table>
