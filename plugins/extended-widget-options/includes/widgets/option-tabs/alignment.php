                ...
                <tr valign="top">
                    ...
                    <td>
                        <select class="widefat" name="<?php echo $args['namespace'];?>[extended_widget_opts][alignment][tablet]">
                            <option value="default"><?php _e( 'Default', 'widget-options' );?></option>
                            <option value="center" <?php if( $tablet == 'center' ){ echo 'selected="selected"'; }?> ><?php _e( 'Center', 'widget-options' );?></option>
                            <option value="left" <?php if( $tablet == 'left' ){ echo 'selected="selected"'; }?>><?php _e( 'Left', 'widget-options' );?></option>
                            <option value="right" <?php if( $tablet == 'right' ){ echo 'selected="selected"'; }?>><?php _e( 'Right', 'widget-options' );?></option>
                            <option value="justify" <?php if( $tablet == 'justify' ){ echo 'selected="selected"'; }?>><?php _e( 'Justify', 'widget-options' );?></option>
                        </select>
                    </td>
                </tr>
                <tr valign="top">
                    ...
                    <td>
                        <select class="widefat" name="<?php echo $args['namespace'];?>[extended_widget_opts][alignment][mobile]">
                            <option value="default"><?php _e( 'Default', 'widget-options' );?></option>
                            <option value="center" <?php if( $mobile == 'center' ){ echo 'selected="selected"'; }?> ><?php _e( 'Center', 'widget-options' );?></option>
                            <option value="left" <?php if( $mobile == 'left' ){ echo 'selected="selected"'; }?>><?php _e( 'Left', 'widget-options' );?></option>
                            <option value="right" <?php if( $mobile == 'right' ){ echo 'selected="selected"'; }?>><?php _e( 'Right', 'widget-options' );?></option>
                            <option value="justify" <?php if( $mobile == 'justify' ){ echo 'selected="selected"'; }?>><?php _e( 'Justify', 'widget-options' );?></option>
                        </select>
                    </td>
                </tr>
            </tbody>
